            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description_de" rows="5" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="ltr">{{ old('description_de') }}</textarea>
                        @error('description_de')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Slug (Deutsch) — optional</label>
                        <input type="text" name="slug_de" value="{{ old('slug_de') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none font-mono text-sm" dir="ltr">
