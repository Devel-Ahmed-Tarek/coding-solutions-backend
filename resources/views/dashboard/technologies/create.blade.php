        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" name="name_de" value="{{ old('name_de') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="ltr" placeholder="Laravel">
