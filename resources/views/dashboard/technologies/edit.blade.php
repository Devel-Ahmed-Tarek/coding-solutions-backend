...
<div class="mb-8">
    ...
    <p class="text-gray-500 mt-1">{{ $technology->name }}</p>
</div>
    ...
    <form action="{{ route('dashboard.technologies.update', $technology) }}" method="POST">
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $technology->name) }}" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none">
