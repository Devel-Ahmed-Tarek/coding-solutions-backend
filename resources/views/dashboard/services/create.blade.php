    ...
    <form action="{{ route('dashboard.services.store') }}" method="POST">
        ...
        <div class="space-y-8">
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description_ar" rows="4" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="rtl">{{ old('description_ar') }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon') }}" placeholder="database" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none">
            </div>
            <div>
