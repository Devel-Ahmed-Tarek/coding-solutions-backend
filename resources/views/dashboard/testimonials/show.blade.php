...
<div class="mb-8 flex justify-between items-start">
    <div>
        ...
        <p class="text-gray-500 mt-1" dir="ltr">{{ $testimonial->name_en }}@if($testimonial->name_de) · {{ $testimonial->name_de }}@endif</p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-3xl space-y-6">
    <div>
        ...
        <p class="text-gray-600 text-sm mt-1" dir="ltr">{{ $testimonial->job_title_en ?? '—' }}@if($testimonial->job_title_de) · {{ $testimonial->job_title_de }}@endif</p>
    </div>
    <div>
    ...
    @if($testimonial->quote_de)
    <div>
        <h3 class="text-sm font-medium text-gray-500 mb-2">Zitat — Deutsch</h3>
        <p class="text-gray-800" dir="ltr">{{ $testimonial->quote_de }}</p>
    </div>
    @endif
