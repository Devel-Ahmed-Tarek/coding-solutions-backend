            ...
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name_de" value="{{ old('name_de') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="ltr">
                    ...
                    <div>
                        ...
                        <input type="text" name="job_title_de" value="{{ old('job_title_de') }}" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="ltr">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Zitat (Deutsch)</label>
                        <textarea name="quote_de" rows="4" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none" dir="ltr">{{ old('quote_de') }}</textarea>
